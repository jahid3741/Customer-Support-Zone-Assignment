...
// const CustomerTickets = ({ cardDetails }) => {
//   const { id, title, description, customer, priority, status, createdAt } = cardDetails;
...
//         <div className={`flex items-center gap-2 px-4 py-1 rounded-full text-sm font-medium ${statusStyles[status]}`}>
...
//             <img src="https://i.ibb.co.com/ks44KP3d/Vector.png" alt="" />
//             <span>{createdAt}</span>
//           </div>
//         </div>
//       </div>
